...
<div class="navbar-fixed container-fluid">
  <nav class="brown darken-4 " >
    ...
    <div class="container">
        ...
        <h4 class="text-center"> Redefina a sua senha agora mesmo!</h4>

        <div class="row text-center">
            <form class="col s12" action="/password/reset" method="POST">
                 {!! csrf_field() !!}
                ...
                <div class="row">
                    <div class="card card-content">
                            ...
                            <div class="input-field col s6 offset-s2">
                                ...
                                <label class="active" for="password">Confirmação de Senha</label>
                            </div>

                        <div class="card-action input-field col s8">
                            <button class="waves-effect waves-light green darken-4 btn" type="submit">Redefinir Senha</button>
                        </div>
                    </div>
                </div>
            </form>
