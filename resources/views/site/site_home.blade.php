	...
	<!-- ================================================================================================ -->
   	 			...
   	 			<div class="row col s12">
					    ...
					    <div class="card-reveal">
					    	<span class="card-title grey-text text-darken-4">CTFlor - 2014<i class="material-icons right">close</i></span>
					    	<p>
					    		O CTFlor 2014 é um evento que ocorrereu na UFSCar e serve para demontrar a dinâmica do site na visão do cliente final e consumidor  da aplicação.
					    		<br>
					    		Outra apresentação retirada do site:
					    		<br>
				    			http://www.congressoflorestal.com.br/apresentacao.html
				    			<br>
