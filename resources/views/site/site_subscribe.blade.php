            ...
            <div class="col s12">
                    ...
                    <h4 class="text-center"> Inscreva-se no evento!</h4>
    								...
    								<!--			<div class="card large  card-panel">-->
    													...
    													<div class="input-field col l4 m4 s12 text-center">
                            ...
                            <div class="input-field col l4 m4 s12">
                              ...
                              <span id="span-password" ></span>
    													...
    													<div class="input-field col l6 m6 s12 offset-s2 center">
